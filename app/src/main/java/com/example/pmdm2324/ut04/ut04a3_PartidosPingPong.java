...
public class ut04a3_PartidosPingPong extends AppCompatActivity {
    ...
    ut04f3_PingPongFragment partido1, partido2, partido3, partido4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ut04a3_partidos_ping_pong);
        ...
        partido1 = (ut04f3_PingPongFragment) getSupportFragmentManager().findFragmentById(R.id.ut4a3idfrPartido1);
        partido2 = (ut04f3_PingPongFragment) getSupportFragmentManager().findFragmentById(R.id.ut4a3idfrPartido2);
