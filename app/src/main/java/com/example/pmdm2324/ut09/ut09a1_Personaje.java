...
public class ut09a1_Personaje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ut09a1_personaje);
        ...
        get.setOnClickListener((v)->{
            ...
            Call<Personaje> llamada =  ser.getRepo().getCharacter(String.valueOf(Integer.parseInt(id.getText().toString())));
